    ...
    return (
        <View >
            ...
            <View style={styles.fullbar}>
                ...
                <View style={styles.step}>
                    <Image 
                    source={transfer ? require('../assets/transfer-active.png') : require('../assets/transfer-default.png')}
                    style={styles.stepIcon}
                    />
                    <Text style={styles.description}>
                ...
                <View style={styles.step}>
                    <Image 
                    source={complete ? require('../assets/done-active.png') : require('../assets/done-default.png')}
                    style={styles.stepIcon}
                    />
                    <Text style={styles.description}>
